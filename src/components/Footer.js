...
<footer className="bg-black text-white relative mt-60 font-Comfortaa">
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 py-6 ">
              <button  className="flex items-center">
                  <img src={logo} className="h-8 mr-3 px-2 rounded-lg bg-white" alt=" Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap sr-only ">SalesCaptian</span>
              </button>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-200 sm:text-center ">© 2023 <a href="#" className="hover:underline">SalesCaptain</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="#" className="text-gray-200 hover:text-white dark:hover:text-white">
